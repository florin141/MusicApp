...
public class SongFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        allSongs.addAll(album1.getSongs());
        allSongs.addAll(album2.getSongs());
        allSongs.addAll(album3.getSongs());
        allSongs.addAll(album4.getSongs());

        SongAdapter adapter = new SongAdapter(getActivity(), allSongs);
